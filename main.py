...
class Building:
    ...
    def __init__(self):
        super(Building, self).__init__() # Необязательно (инициализатор класса object)
        n = randint(5, 20)
    ...
    def generate_simulation(self) -> list:
        """Создание новой симуляции. Параметры: этажей от 5 до 20, людей от 0 до 10 на каждом этаже"""
        passengers_list = []
